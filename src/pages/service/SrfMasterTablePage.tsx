...
const statusClass: Record<string, string> = {
  ...
  brand_credit_note_pending_ho: "bg-sky-100 text-sky-950 ring-sky-300/80",
  brand_credit_note_pending_accounts: "bg-amber-100 text-amber-950 ring-amber-300/80",
...
const STATUS_LABELS: Record<string, string> = {
  ...
  brand_credit_note_pending_ho: "Brand CN pending HO",
  brand_credit_note_pending_accounts: "Brand CN pending accounts",
