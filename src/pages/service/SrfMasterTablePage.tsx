...
const statusClass: Record<string, string> = {
  ...
  pending_ho_transit: "bg-amber-100 text-amber-800",
  in_transit_sc: "bg-blue-100 text-blue-700",
  awaiting_sc_inward: "bg-sky-100 text-sky-800",
  received_at_sc: "bg-violet-100 text-violet-700",
  pending_store_transit: "bg-amber-100 text-amber-800",
  awaiting_store_inward: "bg-sky-100 text-sky-800",
