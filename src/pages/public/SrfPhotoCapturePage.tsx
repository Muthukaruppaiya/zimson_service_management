            ...
            {!documentPhoto ? (
              ...
              <div className="flex items-center gap-3 rounded-xl border border-[#3B82F6]/30 bg-[#fffdf5] p-2.5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2 flex flex-wrap gap-1.5">
                    <a
                      href={publicMediaUrl(documentPhoto.filePath)}
                      target="_blank"
                      rel="noreferrer"
                      className={`${thumbActionBtn} border-emerald-200 bg-emerald-50 px-3 text-xs font-bold text-emerald-800 hover:bg-emerald-100`}
                    >
                      View document
                    </a>
                    <button
