...
const navItems: Array<{ to: string; label: string }> = [
  ...
  { to: "/inventory/service-package-types", label: "Package types" },
  ...
  { to: "/inventory/vouchers", label: "New voucher" },
  { to: "/inventory/voucher-history", label: "Voucher history" },
  { to: "/inventory/po-inward", label: "GRN" },
  { to: "/inventory/grn-history", label: "GRN History" },
  { to: "/inventory/purchase-return", label: "GRN return" },
  { to: "/inventory/purchase-return-history", label: "GRN return history" },
  { to: "/inventory/ho-transfer", label: "Transfers" },
  { to: "/inventory/transfer-history", label: "Transfers history" },
