...
export const QUICK_LINK_ICON_TONE: Record<DashboardQuickLinkId, QuickLinkIconTone> = {
  quick_bill: { tile: CHRONO_TILE, icon: "", hoverRing: "group-hover:ring-[#C9A227]/40" },
  srf_booking: { tile: CHRONO_TILE, icon: "", hoverRing: "group-hover:ring-[#1B3A8F]/25" },
  parts_order: { tile: CHRONO_TILE, icon: "", hoverRing: "group-hover:ring-[#C9A227]/30" },
  quick_bill_history: { tile: CHRONO_TILE, icon: "", hoverRing: "group-hover:ring-[#1B3A8F]/25" },
  srf_register: { tile: CHRONO_TILE, icon: "", hoverRing: "group-hover:ring-[#C9A227]/30" },
  ...
  store_dispatch: { tile: CHRONO_TILE, icon: "", hoverRing: "group-hover:ring-[#C9A227]/30" },
